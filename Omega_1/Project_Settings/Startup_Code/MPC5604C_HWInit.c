/*
 *
 * FILE : MPC5604C_HWInit.c
 *
 * DESCRIPTION:
 *  This file contains the initialization for MPC5604C derivative.
 *
 *  VERSION: 1.0
 */

#include "MPC5604C.h"   /* platform development header */
#include "MPC5604C_HWInit.h"
